...
contract('DNSSEC', function(accounts) {
  ...
  describe('submit', async function() {
    beforeEach(async function() {
          ...
          packet.encode({
            ...
            authorities: [
              ...
              },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('NSEC', 'matoken.xyz', {
                  labels: 3,
                  keyTag: 1277
                })
              }
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABB21hdG9rZW4DeHl6AAAwAAEAACkQAAAAgAAAAA=='
        })
        .times(2)
        .reply(
          200,
          packet.encode({
            ...
            answers: [
              ...
              },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('DNSKEY', 'matoken.xyz', { labels: 2 })
              }
            ]
          })
        );
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABB21hdG9rZW4DeHl6AAArAAEAACkQAAAAgAAAAA=='
        })
        .times(2)
        .reply(
          200,
          packet.encode({
            ...
            answers: [
              { name: 'matoken.xyz', type: 'DS', class: 'IN', data: dsdata },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('DS', 'xyz', { labels: 2 })
              }
            ]
          })
        );
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABA3h5egAAMAABAAApEAAAAIAAAAA='
        })
        .times(2)
        .reply(
          200,
          packet.encode({
            ...
            answers: [
              ...
              { name: 'xyz', type: 'DNSKEY', class: 'IN', data: dnskeydata2 },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('DNSKEY', 'xyz', { labels: 1 })
              }
            ]
          })
        );
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABA3h5egAAKwABAAApEAAAAIAAAAA='
        })
        .times(2)
        .reply(
          200,
            ...
            answers: [
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('DS', '.', { labels: 1, keyTag: 5647 })
              },
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABAAAwAAEAACkQAAAAgAAAAA=='
        })
        .times(2)
        .reply(
          200,
          packet.encode({
            ...
            answers: [
              ...
              },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('DNSKEY', '.', { labels: 0, keyTag: 5647 })
              }
            ]
          })
        );
    ...
    it('full end to end test', async function() {
      ...
      for (let i = 0; i < proofs.length; i++) {
        ...
        await oracle.submitProof(proof, proofs[i - 1], {
          from: owner,
          gas: gas
        });
    ...
    this.beforeEach(async function() {
      ...
      nock('https://cloudflare-dns.com')
        ...
        .query({
          ct: 'application/dns-udpwireformat',
          ts: /.*/,
          dns: 'AAEBAAABAAAAAAABAWIAABAAAQAAKRAAAACAAAAA'
        })
        .once()
        .reply(
          200,
          packet.encode({
            ...
            answers: [
              ...
              },
              {
                ...
                class: 'IN',
                ttl: 3600,
                data: rrsigdata('TXT', '.', { labels: 1, keyTag: 5647 })
              }
            ]
          })
        );
  ...
  describe('delete', async function() {
            ...
            answers: [
              {
                ...
                type: 'TXT',
                class: 'IN',
                data: Buffer.from(`a=${owner}`, 'ascii')
              },
              {
                name: 'b',
                type: 'RRSIG',
          ...
          packet.encode({
            ...
            authorities: [
              ...
              },
              {
                ...
                type: 'RRSIG',
                class: 'IN',
                data: rrsigdata('NSEC', '.', { labels: 1, keyTag: 5647 })
              }
            ]
          })
        );
    ...
    it('deletes .b', async function() {
      ...
      assert.equal(dnsResult.found, true);
      assert.equal(
        dnsResult.results[1].rrs[0].data.toString().split('=')[1],
        owner
      );
      let proofs = dnsResult.proofs;
      // adding proofs;
      ...
      assert.equal(dnsResult2.nsec, true);
      let nsecproofs = dnsResult2.proofs;
      await oracle.deleteProof('TXT', 'b', nsecproofs[1], nsecproofs[0], {
        from: owner,
        gas: gas
      });
